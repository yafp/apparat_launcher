...
class simpleapp_tk(tk.Tk):
    ...
    def initUI(self):
        ...
        # define some images
        self.bt_IconExecute = tk.PhotoImage(file="bt_appIcon_16.png")        # pick a (small) image file you have in the working directory
        self.bt_IconPreferences = tk.PhotoImage(file="bt_prefs_16.png")
        self.bt_IconGithub = tk.PhotoImage(file="bt_github_16.png") 
    ...
    def setApplicationIcon(self):
        ...
        # set app icon
        img = tk.Image("photo", file="bt_appIcon_16.png")
